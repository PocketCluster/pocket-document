# ---------------- FQDN ----------------
# us-south-01.cdn.pocketcluster.io

# ---------------- /etc/hostname ---------------- 
echo "us-south-01" > /etc/hostname
...
107.173.125.195 us-south-01.cdn.pocketcluster.io us-south-01
127.0.1.1       us-south-01.cdn.pocketcluster.io us-south-01 
...
scp us-south-01.cdn.pocketcluster.io:~/deb-installed.log .
...
sender = root@us-south-01.cdn.pocketcluster.io
port = 0:65535
banaction = iptables-multiport

scp jail.local us-south-01:~/
scp filter.d/* us-south-01:~/
...
cd /opt/letsencrypt
./letsencrypt-auto certonly --standalone --email stkim1@colorfulglue.com -d us-south-01.cdn.pocketcluster.io

: <<OUTPUT
Saving debug log to /var/log/letsencrypt/letsencrypt.log
Obtaining a new certificate
Performing the following challenges:
tls-sni-01 challenge for us-south-01.cdn.pocketcluster.io
Waiting for verification...
Cleaning up challenges

IMPORTANT NOTES:
 - Congratulations! Your certificate and chain have been saved at:
   /etc/letsencrypt/live/us-south-01.cdn.pocketcluster.io/fullchain.pem
   Your key file has been saved at:
   /etc/letsencrypt/live/us-south-01.cdn.pocketcluster.io/privkey.pem
...
scp default us-south-01:~/
scp us-south-01.cdn.pocketcluster.io.conf us-south-01:~/
scp nginx.conf us-south-01:~/

mv default /etc/nginx/sites-available/
mv us-south-01.cdn.pocketcluster.io.conf /etc/nginx/conf.d/
...
# ---------------- CDN Serve Install ---------------- 
scp cdnserve.service us-south-01:~/
scp cdnserve us-south-01:~/

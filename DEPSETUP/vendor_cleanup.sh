...
function clean_gopath() {
	...
	rm -rf github.com/cloudfoundry/gosigar && (rmdir github.com/cloudfoundry > /dev/null 2>&1 || true)
	...
	rm -rf github.com/cyberdelia/go-metrics-graphite && (rmdir github.com/cyberdelia > /dev/null 2>&1 || true)
	...
	rm -rf github.com/mrunalp/fileutils && (rmdir github.com/mrunalp > /dev/null 2>&1 || true)
	rm -rf github.com/seccomp/libseccomp-golang && (rmdir github.com/seccomp > /dev/null 2>&1 || true)
	rm -rf github.com/rcrowley/go-metrics && (rmdir github.com/rcrowley > /dev/null 2>&1 || true)

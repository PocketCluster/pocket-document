...
rm -rf github.com/denverdino/aliyungo && (rmdir github.com/denverdino > /dev/null 2>&1 || true)
...
rm -rf github.com/docker/goamz && (rmdir github.com/docker > /dev/null 2>&1 || true)
...
rm -rf github.com/ncw/swift && (rmdir github.com/ncw > /dev/null 2>&1 || true)
...
rm -rf github.com/Azure/azure-sdk-for-go && (rmdir github.com/Azure > /dev/null 2>&1 || true)
